...
public class Ascensor extends Domotica{
    
    protected int plantaInicial = 0;
    protected int plantaActual = plantaInicial;
    ...
    @Override
    public void reset(){
        plantaActual = plantaInicial;    
    }
    
    @Override
    public String verEstado(){
        String estado = "Ascensor: planta" + plantaActual;
        return estado;
    }
