...
public class Dial extends Domotica{
    
    protected float dialInicial = 88.0f;
    protected float dialActual = dialInicial;


    
    Dial () {}
    
    public int getNumDial(){
        return numDial;
    }
    ...
    @Override
    public void reset(){
        dialActual = dialInicial;    
    }
    
    @Override
    public String verEstado(){
        String estado = "Dial: " + dialActual + " FM";
        return estado;
    }
}
