...
public class Termostato extends Domotica{
    
    protected LocalDate fechaRevision;
    protected int temperaturaInicial = 20;
    protected int temperatura = temperaturaInicial;
  

    
    Termostato () {}
  
    public void setFechaRevision (String fecha){
        String fRevision;
               fRevision= fecha;
               this.fechaRevision = LocalDate.parse(fRevision);
    }
    public LocalDate getFechaRevision(){
        return fechaRevision;
    }
    
     public int getNumTermostato(){
        return numTermostato;
    }
    ...
    public String verEstado(){
        String estado = "Termostato: " + temperatura + " ºC";
        return estado;
    }
